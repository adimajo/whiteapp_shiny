...
rhub::validate_email(email = substr(utils::maintainer(pkg = "WhiteAppRShiny"), regexec("<", utils::maintainer(pkg = "WhiteAppRShiny"))[[1]][1] + 1, nchar(utils::maintainer(pkg = "WhiteAppRShiny")) - 1),
                     token = token)
